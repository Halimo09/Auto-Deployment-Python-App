...
resource "aws_key_pair" "my_key" {   
  ...
  public_key = file("C:/Users/Mahmoud/.ssh/id_ed25519.pub") 
}
//
...
resource "aws_instance" "CICD" {
  ...
  iam_instance_profile = aws_iam_instance_profile.jenkins_instance_profile.name
   provisioner "local-exec" {
    command = "chmod +x C:/Users/Mahmoud/Desktop/Complete-DevOps-Pipeline-Implementation-main/infra/scripts/config_cicd.sh && C:/Users/Mahmoud/Desktop/Complete-DevOps-Pipeline-Implementation-main/infra/scripts/config_cicd.sh"
